...
})(
  {
    ...
    iSxC: [
      function (require, module, exports) {
        ...
        exports.wrapPeerConnectionEvent = wrapPeerEvent;
        ...
        module.exports = function (window, edgeVersion) {
          ...
          RTCPeerConnection.prototype._createIceGatherer = function (
            ...
            this.transceivers[sdpMLineIndex].bufferCandidates = function (
              ...
              var end =
                !event.candidate || Object.keys(event.candidate).length === 0; // polyfill since RTCIceGatherer.state is not implemented in
              // Edge 10547 yet.

              iceGatherer.state = end ? "completed" : "gathering";

              if (
                pc.transceivers[sdpMLineIndex].bufferedCandidateEvents !== null
              ) {
          ...
          RTCPeerConnection.prototype.setRemoteDescription = function (
            ...
            sections.forEach(function (mediaSection, sdpMLineIndex) {
              ...
              var mid =
                SDPUtils.getMid(mediaSection) || SDPUtils.generateIdentifier(); // Reject datachannels which are not implemented yet.
    ...
    XRic: [
      function (require, module, exports) {
        ...
        var _rtcpeerconnectionShim = _interopRequireDefault(
          require("rtcpeerconnection-shim")
        );
        ...
        function shimPeerConnection(window, browserDetails) {
          ...
          var RTCPeerConnectionShim = (0, _rtcpeerconnectionShim.default)(
            window,
            ...
            window.RTCPeerConnection.prototype.addTrack = function addTrack(
              ...
              for (
                var _len = arguments.length,
                  streams = new Array(_len > 1 ? _len - 1 : 0),
                  _key = 1;
                _key < _len;
                _key++
              ) {
      ...
      function (require, module, exports) {
        ...
        function shimMaxMessageSize(window, browserDetails) {
          ...
          var getMaxMessageSize = function (description, remoteIsFirefox) {
            ...
            var match = _sdp.default.matchPrefix(
              description.sdp,
              "a=max-message-size:"
            );
    ...
    KtlG: [
      function (require, module, exports) {
        ...
        var chromeShim = _interopRequireWildcard(
          require("./chrome/chrome_shim")
        );

        var edgeShim = _interopRequireWildcard(require("./edge/edge_shim"));

        var firefoxShim = _interopRequireWildcard(
          require("./firefox/firefox_shim")
        );

        var safariShim = _interopRequireWildcard(
          require("./safari/safari_shim")
        );
          ...
          (function () {
            ...
            Logger.prototype.log = function () {
              ...
              if (this._logLevel >= LogLevel.All) {
                this._print.apply(
                  this,
                  __spreadArray([LogLevel.All], __read(args))
                );
              }
            };
            ...
            Logger.prototype.warn = function () {
              ...
              if (this._logLevel >= LogLevel.Warnings) {
                this._print.apply(
                  this,
                  __spreadArray([LogLevel.Warnings], __read(args))
                );
              }
            };
            ...
            Logger.prototype.error = function () {
              ...
              if (this._logLevel >= LogLevel.Errors) {
                this._print.apply(
                  this,
                  __spreadArray([LogLevel.Errors], __read(args))
                );
              }
            };
            ...
            Logger.prototype._print = function (logLevel) {
              ...
              if (logLevel >= LogLevel.All) {
                ...
                console.warn.apply(
                  console,
                  __spreadArray(["WARNING"], __read(copy))
                );
              } else if (logLevel >= LogLevel.Errors) {
                console.error.apply(
                  console,
                  __spreadArray(["ERROR"], __read(copy))
                );
              }
            };
    ...
    ZRYf: [
      function (require, module, exports) {
        ...
        (function (PeerEventType) {
          ...
          (PeerEventType =
            exports.PeerEventType || (exports.PeerEventType = {}))
        );
        ...
        (function (PeerErrorType) {
          ...
          (PeerErrorType =
            exports.PeerErrorType || (exports.PeerErrorType = {}))
        );
        ...
        (function (SerializationType) {
          ...
          (SerializationType =
            exports.SerializationType || (exports.SerializationType = {}))
        );
        ...
        var Socket =
          ...
          (function (_super) {
            ...
            Socket.prototype._sendHeartbeat = function () {
              if (!this._wsOpen()) {
                logger_1.default.log(
                  "Cannot send heartbeat, because socket closed"
                );
                return;
              }
            ...
            Socket.prototype._sendQueuedMessages = function () {
              ...
              try {
                for (
                  var copiedQueue_1 = __values(copiedQueue),
                    copiedQueue_1_1 = copiedQueue_1.next();
                  !copiedQueue_1_1.done;
                  copiedQueue_1_1 = copiedQueue_1.next()
                ) {
        ...
        var Negotiator =
          ...
          (function () {
            ...
            Negotiator.prototype.startConnection = function (options) {
              ...
              if (
                this.connection.type === enums_1.ConnectionType.Media &&
                options._stream
              ) {
              ...
              peerConnection.oniceconnectionstatechange = function () {
                switch (peerConnection.iceConnectionState) {
                  case "failed":
                    ...
                    _this.connection.emit(
                      enums_1.ConnectionEventType.Error,
                      new Error(
                ...
                _this.connection.emit(
                  enums_1.ConnectionEventType.IceStateChanged,
                  ...
                  switch (_a.label) {
                    ...
                    case 2:
                      ...
                      if (
                        ...
                        offer.sdp =
                          this.connection.options.sdpTransform(offer.sdp) ||
                          offer.sdp;
                      }
                    ...
                    case 4:
                      ...
                      if (
                        this.connection.type === enums_1.ConnectionType.Data
                      ) {
                  ...
                  switch (_a.label) {
                    ...
                    case 2:
                      ...
                      if (
                        ...
                        answer.sdp =
                          this.connection.options.sdpTransform(answer.sdp) ||
                          answer.sdp;
                      }
            ...
            Negotiator.prototype._addTracksToConnection = function (
              stream,
              peerConnection
            ) {
              logger_1.default.log(
            ...
            Negotiator.prototype._addStreamToMediaConnection = function (
              stream,
              mediaConnection
            ) {
              logger_1.default.log(
        ...
        var MediaConnection =
          ...
          (function (_super) {
            ...
            MediaConnection.prototype.addStream = function (remoteStream) {
              ...
              _super.prototype.emit.call(
                this,
                enums_1.ConnectionEventType.Stream,
                remoteStream
              ); // Should we call this `open`?
            };
            ...
            MediaConnection.prototype.answer = function (stream, options) {
              ...
              this._negotiator.startConnection(
                __assign(__assign({}, this.options._payload), {
                  _stream: stream,
                })
            ...
            MediaConnection.prototype.close = function () {
              ...
              _super.prototype.emit.call(
                this,
                enums_1.ConnectionEventType.Close
              );
            };
        ...
        var DataConnection =
          ...
          (function (_super) {
            ...
            function DataConnection(peerId, provider, options) {
              ...
              _this.connectionId =
                _this.options.connectionId ||
                DataConnection.ID_PREFIX + util_1.util.randomToken();
              _this.label = _this.options.label || _this.connectionId;
              _this.serialization =
                _this.options.serialization || enums_1.SerializationType.Binary;
            ...
            DataConnection.prototype._configureDataChannel = function () {
              ...
              if (
                !util_1.util.supports.binaryBlob ||
                util_1.util.supports.reliable
              ) {
              ...
              this.dataChannel.onopen = function () {
                logger_1.default.log(
                  "DC#" + _this.connectionId + " dc connection success"
                );
                _this._open = true;
              ...
              this.dataChannel.onmessage = function (e) {
                logger_1.default.log(
                  "DC#" + _this.connectionId + " dc onmessage:",
                  e.data
                );
              ...
              this.dataChannel.onclose = function () {
                logger_1.default.log(
                  "DC#" + _this.connectionId + " dc closed for:",
                  _this.peer
                );
            ...
            DataConnection.prototype._handleDataMessage = function (_a) {
              ...
              var isBinarySerialization =
                this.serialization === enums_1.SerializationType.Binary ||
              ...
              if (isBinarySerialization) {
                ...
                this.serialization === enums_1.SerializationType.JSON
              ) {
              ...
              _super.prototype.emit.call(
                this,
                enums_1.ConnectionEventType.Data,
                deserializedData
              );
            };
            ...
            DataConnection.prototype._sendChunks = function (blob) {
              ...
              try {
                for (
                  var blobs_1 = __values(blobs), blobs_1_1 = blobs_1.next();
                  !blobs_1_1.done;
                  blobs_1_1 = blobs_1.next()
                ) {
                ...
                return __generator(this, function (_a) {
                  switch (_a.label) {
                    ...
                    case 3:
                      error_2 = _a.sent();
                      logger_1.default.error(
                        "Error retrieving list peers",
                        error_2
                      );
                      throw new Error(
                        "Could not get list peers from the server." + error_2
                      );
          ...
          (function (_super) {
            ...
            function Peer(id, options) {
              ...
              if (_this._options.path) {
                ...
                if (
                  _this._options.path[_this._options.path.length - 1] !== "/"
                ) {
                  _this._options.path += "/";
                }
              ...
              if (
                _this._options.secure === undefined &&
                _this._options.host !== util_1.util.CLOUD_HOST
              ) {
              ...
              if (
                !util_1.util.supports.audioVideo &&
                !util_1.util.supports.data
              ) {
                _this._delayedAbort(
                  enums_1.PeerErrorType.BrowserIncompatible,
              ...
              if (!!userId && !util_1.util.validateId(userId)) {
                _this._delayedAbort(
                  enums_1.PeerErrorType.InvalidID,
              ...
              if (userId) {
                ...
                _this._api
                  ...
                  .catch(function (error) {
                    return _this._abort(
                      enums_1.PeerErrorType.ServerError,
                      error
                    );
                  });
              }
            ...
            Object.defineProperty(Peer.prototype, "connections", {
              ...
              get: function get() {
                ...
                try {
                  for (
                    var _b = __values(this._connections), _c = _b.next();
                    !_c.done;
                    _c = _b.next()
                  ) {
            ...
            Peer.prototype._createServerConnection = function () {
              ...
              socket.on(enums_1.SocketEventType.Close, function () {
                ...
                _this._abort(
                  enums_1.PeerErrorType.SocketClosed,
            ...
            Peer.prototype._handleMessage = function (message) {
              ...
              switch (type) {
                ...
                case enums_1.ServerMessageType.IdTaken:
                  ...
                  this._abort(
                    enums_1.PeerErrorType.UnavailableID,
                    'ID "' + this.id + '" is taken'
                  );
                ...
                case enums_1.ServerMessageType.InvalidKey:
                  ...
                  this._abort(
                    enums_1.PeerErrorType.InvalidKey,
                ...
                case enums_1.ServerMessageType.Expire:
                  ...
                  this.emitError(
                    enums_1.PeerErrorType.PeerUnavailable,
                ...
                case enums_1.ServerMessageType.Offer: {
                  ...
                  if (payload.type === enums_1.ConnectionType.Media) {
                    connection = new mediaconnection_1.MediaConnection(
                      peerId,
                      this,
                      {
                        connectionId: connectionId,
                    ...
                    connection = new dataconnection_1.DataConnection(
                      peerId,
                      this,
                      {
                        connectionId: connectionId,
            ...
            Peer.prototype.connect = function (peer, options) {
              ...
              if (this.disconnected) {
                ...
                this.emitError(
                  enums_1.PeerErrorType.Disconnected,
            ...
            Peer.prototype.call = function (peer, stream, options) {
              ...
              var mediaConnection = new mediaconnection_1.MediaConnection(
                peer,
                this,
                options
              );
            ...
            Peer.prototype.getConnection = function (peerId, connectionId) {
              ...
              try {
                for (
                  var connections_1 = __values(connections),
                    connections_1_1 = connections_1.next();
                  !connections_1_1.done;
                  connections_1_1 = connections_1.next()
                ) {
            ...
            Peer.prototype._cleanup = function () {
              ...
              try {
                for (
                  var _b = __values(this._connections.keys()), _c = _b.next();
                  !_c.done;
                  _c = _b.next()
                ) {
                  var peerId = _c.value;
            ...
            Peer.prototype._cleanupPeer = function (peerId) {
              ...
              try {
                for (
                  var connections_2 = __values(connections),
                    connections_2_1 = connections_2.next();
                  !connections_2_1.done;
                  connections_2_1 = connections_2.next()
                ) {
